...
import { userListServices } from '../../../services/api.services';

const DoctorsDashboardComponent = () => {
  ...
  const fetchUsedBasedData = (e: any) => {
      ...
      <div className='container mx-auto p-4'>
        <div className='grid grid-cols-2 gap-3'>
          <div className='grid grid-cols-2 gap-3'>
            ...
            <div>
              <div className='block max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 mb-10'>
                <select onChange={fetchUsedBasedData}>
              ...
              <div className='block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 mb-10'>
                <svg className='h-[25px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
                  <path d="M160 64c-26.5 0-48 21.5-48 48l0 164.5c0 17.3-7.1 31.9-15.3 42.5C86.2 332.6 80 349.5 80 368c0 
                             ...
                             112C48 50.2 98.1 0 160 0s112 50.1 112 112l0 164.4c0 .1 .1 .3 .2 .6c.2 .6 .8 1.6 1.7 2.8c18.9 24.4 30.1 55 30.1
                              ...
                              112zM208 368c0 26.5-21.5 48-48 48s-48-21.5-48-48c0-20.9 13.4-38.7 32-45.3L144 208c0-8.8 7.2-16 16-16s16 7.2 16 16l0 114.7c18.6 6.6 32 24.4 32 45.3z" /></svg>
            ...
            <div>
              <div className='block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 mb-10'>
                <svg className='h-[25px]' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                  <path d="M192 512C86 512 0 426 0 320C0 228.8 130.2 57.7 166.6 11.7C172.6 4.2 181.5 0 191.1 0l1.8 0c9.6 0 18.5 4.2 24.5 11.7C253.8 57.7 384 228.8 384 320c0 106-86 192-192 192zM96 336c0-8.8-7.2-16-16-16s-16 7.2-16 16c0 61.9 50.1 112 112 112c8.8 0 16-7.2 16-16s-7.2-16-16-16c-44.2 0-80-35.8-80-80z" /></svg>
          ...
          <div>
            <div className='container mx-auto '>
              <div className=' h-[255px] block max-w-sm p-10 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 heart-rate'>
                <h2 className="mb-2 text-lg font-semibold ">User Allergy Details</h2>
...
export default DoctorsDashboardComponent;
